  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-12 overflow-hidden px-6">
      ...
      <div className="container mx-auto text-center relative z-10">
       ...
       <button 
         onClick={triggerInscricao}
         className="mb-12 bg-oxe-yellow text-black font-black uppercase tracking-widest px-8 py-4 rounded-none border-2 border-oxe-yellow shadow-[6px_6px_0px_#000]
