  ...
  const competitions = [
    {
      ...
      editalLink: '/editais/Atualização Regras Buzz_Line.pdf'
    },
    {
      id: 'buzzpro',
      title: 'Buzz PRO',
    ...
    },
    {
      ...
      editalLink: '/editais/Edital SUMÔ-2.pdf'
    },
    {
      id: 'combate',
      ...
      <div className="bg-oxe-dark border-b border-white/5 py-16 px-6">
        <div className="container mx-auto text-center">
          <h1 className="font-logo text-6xl md:text-8xl font-black mb-4 uppercase text-white">
            Torneio de <span className="text-oxe-yellow">Robótica</span>
          </h1>
          <p className="font-mono text-white/50 max-w-2xl mx-auto">
            Onde a tecnologia encontra a adrenalina. Participe das maiores competições de robótica da região e mostre o poder da sua criação.
          </p>
        </div>
      </div>
